...
>(({ className, children, variant = 'default', size = 'default', error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      variant === 'eco' && "border-eco-200 focus:ring-eco-500 focus:border-eco-500",
      variant === 'glass' && "glass border-white/20 focus:border-white/40",
